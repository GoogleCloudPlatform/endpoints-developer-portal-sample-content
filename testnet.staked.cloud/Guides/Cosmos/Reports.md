...
Shell example:
  ```bash
    $ curl -X GET "http://localhost:8888/api/reports/COSMOS/delegator/cosmos10e4vsut6suau8tk9m6dnrm0slgd6npe3hjqndl/balance?api_key=<YOURAPIKEY>"
  ```
...
Shell example:  
  ```bash
    $ curl -X GET "http://localhost:8888/api/reports/COSMOS/delegator/cosmos10e4vsut6suau8tk9m6dnrm0slgd6npe3hjqndl/txns?api_key=<YOURAPIKEY>&start=2019-04-02&kind=paid"
  ```
...
Shell example:
  ```bash
    $ curl -X GET "http://localhost:8888/api/reports/COSMOS/balance?api_key=<YOURAPIKEY>"
  ```
...
Shell example:  
  ```bash
    $ curl -X GET "http://localhost:8888/api/reports/COSMOS/txns?api_key=<YOURAPIKEY>"
  ```
